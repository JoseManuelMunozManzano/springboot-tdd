...
public class GradebookControlledTest {
    ...
    void deleteAValidGradeHttpRequest() throws Exception {
        // Nos aseguramos que el grade existe
        Optional<MathGrade> mathGrade = mathGradesDao.findById(1);

        assertTrue(mathGrade.isPresent());

        // Hacemos el request del delete
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders
        ...
        // Confirmar que el grade fue realmente borrado
    ...
    void deleteAValidGradeHttpRequestStudentIdDoesNotExistEmptyResponse() throws Exception {
        ...
        // Borrar grade (que no existe) con un HTTP Request Get
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders
